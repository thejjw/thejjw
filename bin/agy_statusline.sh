...
echo -e "🧠 \033[35m$model\033[0m | 🔄 \033[36m$agent_state\033[0m | 📊 \033[33m$used_pct%\033[0m \033[36mr\033[33m${ctx_in_fmt}\033[0m+\033[31mw\033[33m${ctx_out_fmt}\033[0m/\033[32mT\033[33m${ctx_max_fmt}\033[0m | 📁 \033[34m$cwd\033[0m$git_info | 👤 \033[37m$plan ($email)\033[0m$sandbox_warn"
