...
#            __MACOSX/AppleDouble junk. When a pack ships multiple formats of the
#            same family the preference is variable -> OTF -> static, so a single
#            variable font replaces a whole static weight set where available.
...
$_FontInstallInternal = @{
    ...
    Packs = @(
        ...
        [pscustomobject]@{ Name = 'Pretendard';          Url = 'https://github.com/orioncactus/pretendard/releases/download/v1.3.9/Pretendard-1.3.9.zip'; Bytes = 47304526; Fonts = 1; Kind = 'Zip'; Include = '(?i)^public/variable/[^/]+\.ttf$'; Probe = 'PretendardVariable.ttf';                Enabled = $true;  Note = 'Variable TTF (upstream-recommended); skips static otf/ttf.' }
        [pscustomobject]@{ Name = 'WantedSans';          Url = 'https://github.com/wanteddev/wanted-sans/releases/download/v1.0.3/WantedSans-1.0.3.zip'; Bytes = 21656532; Fonts = 1; Kind = 'Zip'; Include = '(?i)^variable/[^/]+\.ttf$';                Probe = 'WantedSansVariable.ttf';                 Enabled = $true;  Note = 'Variable TTF; skips static otf/ and ttf/.' }
        ...
        [pscustomobject]@{ Name = 'FiraCode';            Url = 'https://github.com/tonsky/FiraCode/releases/download/6.2/Fira_Code_v6.2.zip'; Bytes = 2462987; Fonts = 1; Kind = 'Zip'; Include = '(?i)^variable_ttf/[^/]+\.ttf$';                 Probe = 'FiraCode-VF.ttf';                        Enabled = $true;  Note = 'Variable TTF; skips static ttf/ set.' }
        ...
        [pscustomobject]@{ Name = 'JetBrainsMono';       Url = 'https://github.com/JetBrains/JetBrainsMono/releases/download/v2.304/JetBrainsMono-2.304.zip'; Bytes = 5622857; Fonts = 2; Kind = 'Zip'; Include = '(?i)^fonts/variable/[^/]+\.ttf$';         Probe = 'JetBrainsMono[wght].ttf';                Enabled = $true;  Note = 'Variable TTF (upright + italic); skips static ttf/ set.' }
        [pscustomobject]@{ Name = 'IBMPlexSans';         Url = 'https://github.com/IBM/plex/releases/download/%40ibm%2Fplex-sans%401.1.0/ibm-plex-sans.zip'; Bytes = 9921777; Fonts = 16; Kind = 'Zip'; Include = '(?i)^ibm-plex-sans/fonts/complete/otf/[^/]+\.otf$'; Probe = 'IBMPlexSans-Regular.otf';        Enabled = $true;  Note = 'OTF (no variable in this archive); skips ttf/ duplicate.' }
        ...
        [pscustomobject]@{ Name = 'MinSans';             Url = 'https://github.com/poposnail61/min-sans/releases/download/v1.4.2/fonts.zip'; Bytes = 31533194; Fonts = 1; Kind = 'Zip'; Include = '(?i)^fonts/variable/[^/]+\.ttf$';             Probe = 'MinSansVF.ttf';                          Enabled = $true;  Note = 'Variable TTF; skips static otf/ and __MACOSX.' }
