...
$_FontInstallInternal = @{
    ...
    Packs = @(
        ...
        [pscustomobject]@{ Name = 'Pretendard';          Url = 'https://github.com/orioncactus/pretendard/releases/download/v1.3.9/Pretendard-1.3.9.zip'; Bytes = 47304526; Fonts = 9; Kind = 'Zip'; Include = '(?i)^public/static/alternative/[^/]+\.ttf$'; Probe = 'Pretendard-Regular.ttf';        Enabled = $true;  Note = 'Static TTF: its variable build registers as family "Pretendard Variable", so static is used for a clean "Pretendard" family.' }
        [pscustomobject]@{ Name = 'WantedSans';          Url = 'https://github.com/wanteddev/wanted-sans/releases/download/v1.0.3/WantedSans-1.0.3.zip'; Bytes = 21656532; Fonts = 7; Kind = 'Zip'; Include = '(?i)^ttf/[^/]+\.ttf$';                     Probe = 'WantedSans-Regular.ttf';                 Enabled = $true;  Note = 'Static TTF: variable build registers as "Wanted Sans Variable"; static keeps a clean "Wanted Sans" family.' }
        ...
        [pscustomobject]@{ Name = 'FiraCode';            Url = 'https://github.com/tonsky/FiraCode/releases/download/6.2/Fira_Code_v6.2.zip'; Bytes = 2462987; Fonts = 6; Kind = 'Zip'; Include = '(?i)^ttf/[^/]+\.ttf$';                          Probe = 'FiraCode-Regular.ttf';                   Enabled = $true;  Note = 'Static TTF: the VF defaults to Light weight and legacy apps see "Fira Code Light"; static defaults to Regular with a clean "Fira Code" family.' }
